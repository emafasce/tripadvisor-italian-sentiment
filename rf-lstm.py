...
trainX=matX[0:TRAINING_AND_VALIDATION_SAMPLES].astype(int)
testX=matX[TRAINING_AND_VALIDATION_SAMPLES:].astype(int)
...
#Splitting into training set and test set
trX=X[0:TRAINING_AND_VALIDATION_SAMPLES]
teX=X[TRAINING_AND_VALIDATION_SAMPLES:]
...
#Saving to file
with open(os.path.join('inputs', 'predictions_rf-lstm.csv'), mode='w') as f:
